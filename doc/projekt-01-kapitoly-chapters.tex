...
Slouží k určení vzdálenosti mezi robotem a překážkou. Funguje na principu radaru. Vyšle ultrazvukovou vlnu na frekvenci 40Khz %je v tutorialu adeept
...
\subsubsection*{WS2812 RGB LED} %najit na tohle nejakou citaci vetsinu informaci odhaduji
...
\subsubsection*{Camera} %cite rpi doc
...
\begin{algorithm}[h!]
	...
	\BlankLine \Indp\Indpp
 	...
 	\BlankLine
	\tcp{zaslaní požadavku na server}
